...
public class Login extends javax.swing.JFrame {
       ...
       public void validateFields()
    {
        ...
        if(email.endsWith(".com") &&!(password==""))
    ...
    private void initComponents() {
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/abstract-blur-supermarket.jpg"))); // NOI18N
    ...
    private void btnlogin2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnlogin2ActionPerformed
        ...
        String password=txtp2.getText();
        User user=null;
       // user=UserQueries.login(email,password);
       if(user==null)  //wrong data is entered
       {
           JOptionPane.showMessageDialog(null,"enter valid data","Message",JOptionPane.ERROR_MESSAGE);
