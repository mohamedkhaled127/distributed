...
public class Signup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnforgot1.setFont(new java.awt.Font("Fira Sans", 1, 14)); // NOI18N
        ...
        getContentPane().add(btnforgot1, new org.netbeans.lib.awtextra.AbsoluteConstraints(212, 527, -1, -1));

        btnlogin1.setFont(new java.awt.Font("Fira Sans", 1, 14)); // NOI18N
        ...
        getContentPane().add(btnlogin1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 527, -1, -1));
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        //User.save(user);  let user data be saved in database
        clear();
